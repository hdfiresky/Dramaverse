...
export const PrivacyPolicyContent = () => (
    <>
        ...
        <ul>
            <li><strong>Account Information:</strong> When you register, we collect a username and password.</li>
        ...
        <ul>
            <li>Your data is stored securely. We take reasonable measures to protect your information from unauthorized access.</li>
            <li>Your password is encrypted (hashed) and never stored in plain text.</li>
            <li>We may use secure cookies to manage your login session. These cookies are essential for the app to function and do not contain any personal information or tracking capabilities.</li>
        </ul>
